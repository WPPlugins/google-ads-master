...
class google_ads_master_widget_viral extends WP_Widget {
	...
	parent::__construct( 'google_ads_master_widget_viral', __('Google Ads Master Viral', 'google_ads_master'), $widget_ops, $control_ops );
	}
...
<div style="background: url(<?php echo plugins_url('images/techgasp-hr.png', dirname(__FILE__)); ?>) repeat-x; height: 10px"></div>
	...
	<div class="description"><b>https://plus.google.com/113505825008581970710/</b></div>
	</p>
<div style="background: url(<?php echo plugins_url('images/techgasp-hr.png', dirname(__FILE__)); ?>) repeat-x; height: 10px"></div>
	<p>
